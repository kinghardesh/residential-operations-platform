 ...
 * Top-level router.
 *
 * Public routes: landing + login. Authenticated routes are grouped by role
 * (resident / owner / admin) under their respective layouts and protected
 * by ProtectedRoute. LoginGate redirects authenticated users to the right
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/profile-setup" element={<LoginGate />} />
